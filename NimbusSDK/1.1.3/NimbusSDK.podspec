...
Pod::Spec.new do |spec|
  ...
  spec.subspec 'NimbusRequestKit' do |ss|
    ss.vendored_frameworks = '**/NimbusAll/xcframeworks/NimbusCoreKit.xcframework',
     '**/NimbusAll/xcframeworks/NimbusRequestKit.xcframework'
  end
  
  spec.subspec 'NimbusRenderKit' do |ss|
    ss.vendored_frameworks = '**/NimbusAll/xcframeworks/NimbusCoreKit.xcframework', 
    '**/NimbusAll/xcframeworks/NimbusRenderKit.xcframework'
    ss.dependency 'GoogleAds-IMA-iOS-SDK', '3.11.2'
  end
