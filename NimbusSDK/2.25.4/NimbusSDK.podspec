Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.25.4/Nimbus-2.25.4.zip',
      :sha256 => '2e50693d9c71265e2affc0af332b1bf4b3b4131f3d1cee6db2877959a81d9bca'
    }
