Pod::Spec.new do |spec|
    ...
    spec.name         = 'NimbusSDK'
    spec.version      = '2.17.1-internal20'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.17.1-internal20/Nimbus-2.17.1-internal20.zip',
      :sha256 => '232e6a7516f1c2886aeccb73887a258becfb1c381511c8b6f3ec87f0e34d0e5e'
    }
    ...
    spec.subspec 'NimbusKit' do |ss|
      ss.vendored_frameworks = ['NimbusKit.xcframework', 'NimbusMobileFuseKit.xcframework']
      ss.dependency 'NimbusSDK/NimbusRequestKit'
      ss.dependency 'NimbusSDK/NimbusRenderKit'      
