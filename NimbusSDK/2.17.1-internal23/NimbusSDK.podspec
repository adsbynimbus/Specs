Pod::Spec.new do |spec|
    ...
    spec.name         = 'NimbusSDK'
    spec.version      = '2.17.1-internal23'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.17.1-internal23/Nimbus-2.17.1-internal23.zip',
      :sha256 => '307013258a806cb659ef58bf0b899bdf444457a37565cc746d121b4845226f7c'
    }
    ...
    spec.subspec 'NimbusKit' do |ss|
      ...
      ss.dependency 'MobileFuseSDK', '~> 1.6.5'
    end
