Pod::Spec.new do |spec|
    ...
    spec.documentation_url = 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/docs/2.1.0-internal.2/docs/index.html'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.1.0-internal.2/Nimbus-2.1.0-internal.2.zip',
      :sha256 => '1d8b69ff3b7c20ae93615cb0898c2fc1e8246d87f4e8e14eb76dbc676386c319'
    }
    ...
    spec.subspec 'NimbusRequestVungleKit' do |ss|
      ss.source_files = 'NimbusVungle/NimbusRequestVungleKit/**/*'
      ss.dependency 'NimbusSDK/NimbusRequestKit'
    ...
    spec.subspec 'NimbusRenderVungleKit' do |ss|
      ss.source_files = 'NimbusVungle/NimbusRenderVungleKit/**/*'
      ss.dependency 'NimbusSDK/NimbusRenderKit'
      ss.dependency 'VungleSDK-iOS', '>=6.12.0'
    end
