Pod::Spec.new do |spec|
    ...
    spec.documentation_url = 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/docs/2.1.0-internal.4/docs/index.html'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.1.0-internal.4/Nimbus-2.1.0-internal.4.zip',
      :sha256 => 'f2c9df0419f8659ed5329cbb16542955b9b2242b759015d664cc5c752b9380d2'
    }
    ...
    spec.subspec 'NimbusVungleKit' do |ss|
      ss.vendored_frameworks = ['NimbusRequestVungleKit.xcframework', 'NimbusRenderVungleKit.xcframework']
      ss.dependency 'NimbusSDK/NimbusRequestKit'
      ss.dependency 'NimbusSDK/NimbusRenderKit'
