Pod::Spec.new do |spec|
    ...
    spec.compiler_flags = '-DNimbusSDKInclude'

    # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #

    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.16.0-internal5/Nimbus-2.16.0-internal5.zip',
      :sha256 => '5d33dfc485b18b3fa9f9ffd27a571a0023a6268e101b20b2e52c5198dd7f6048'
    }
