Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.15.4-internal1/Nimbus-2.15.4-internal1.zip',
      :sha256 => '1086d44f486634ad4790ad7e685ee8c80d3412016b743140a222c4b1f0e6c465'
    }
    ...
    spec.subspec 'NimbusMobileFuseKit' do |ss|
      ss.vendored_frameworks = ['NimbusMobileFuseKit.xcframework']
      ss.dependency 'NimbusSDK/NimbusRequestKit'
	  ss.dependency 'NimbusSDK/NimbusRenderKit'
	  ss.dependency 'MobileFuseSDK', '1.6.1'
    end
    ...
    spec.subspec 'NimbusKit' do |ss|
      ...
      ss.dependency 'NimbusSDK/NimbusRequestKit'
      ss.dependency 'NimbusSDK/NimbusRenderKit'
	  ss.dependency 'NimbusSDK/NimbusMobileFuseKit'
    end
