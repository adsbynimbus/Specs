Pod::Spec.new do |spec|
    ...
    spec.pod_target_xcconfig = { 'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) NimbusSDKInclude' }

    # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #

    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.16.0-internal6/Nimbus-2.16.0-internal6.zip',
      :sha256 => '8f888e4a9e643e38f5b62654d2e691bce6ce64bdc89a9e8b9d44a96e4c628623'
    }
