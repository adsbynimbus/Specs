Pod::Spec.new do |spec|
  ...
  spec.documentation_url = 'https://adsbynimbus-public.s3.amazonaws.com/iOS/docs/1.9.1/docs/index.html'
  ...
  spec.source = {
    :http => 'https://adsbynimbus-public.s3.amazonaws.com/iOS/sdks/1.9.1/Nimbus-1.9.1.zip',
  ...
  spec.subspec 'NimbusGAMKit' do |ss|
    ...
    ss.dependency 'NimbusSDK/NimbusRenderKit'
    ss.dependency 'NimbusSDK/NimbusRequestKit'
    ss.dependency 'Google-Mobile-Ads-SDK', '8.2.0'
  end
