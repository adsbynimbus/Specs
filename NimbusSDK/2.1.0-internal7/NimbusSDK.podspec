Pod::Spec.new do |spec|
    ...
    spec.documentation_url = 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/docs/2.1.0-internal7/docs/index.html'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.1.0-internal7/Nimbus-2.1.0-internal7.zip',
      :sha256 => '91be5139dd9031849509068f816b306d0f115370e2580048da1ccd6b5f8a9c27'
    }
    ...
    spec.subspec 'NimbusRequestAPSKit' do |ss|
      ...
      ss.dependency 'AmazonPublisherServicesSDK', '>=4.2.2'
    end
