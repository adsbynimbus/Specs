Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.11.1-internal1/Nimbus-2.11.1-internal1.zip',
      :sha256 => 'cedd9bf5ab2c38dc7898cd0c2aef5a8ba6277567d7f5dfc0df37f858916119a1'
    }
    ...
    spec.subspec 'NimbusRenderKit' do |ss|
      ss.vendored_frameworks = ['NimbusRenderKit.xcframework', 'OMSDK-Adsbynimbus.xcframework']
      ss.dependency 'NimbusSDK/NimbusCoreKit'
    end
