Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.28.2-internal1/Nimbus-2.28.2-internal1.zip',
      :sha256 => '7dcbddacc2071a018d421e568a829cdb3481f3b61a296e3f2232c403bbc408ba'
    }
    ...
    spec.subspec 'NimbusRequestAPSKit' do |ss|
      ...
      ss.dependency 'AmazonPublisherServicesSDK', '~> 5'
    end
    ...
    spec.subspec 'NimbusMintegralKit' do |ss|
      ss.source_files = 'NimbusMintegral/NimbusMintegralKit/**/*'
      ss.dependency 'NimbusSDK/NimbusKit'
      ss.dependency 'MintegralAdSDK', '>= 7.5.1'
    end

    spec.subspec 'NimbusMobileFuseKit' do |ss|
      ss.source_files = 'NimbusMobileFuse/NimbusMobileFuseKit/**/*'
      ss.dependency 'NimbusSDK/NimbusKit'
      ss.dependency 'MobileFuseSDK', '~> 1.9'
    end

    spec.subspec 'NimbusMolocoKit' do |ss|
      ss.source_files = 'NimbusMoloco/NimbusMolocoKit/**/*'
      ss.dependency 'NimbusSDK/NimbusKit'
      ss.dependency 'MolocoSDKiOS', '~> 3.9'
    end
