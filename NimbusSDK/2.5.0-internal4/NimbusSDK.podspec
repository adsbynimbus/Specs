Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.5.0-internal4/Nimbus-2.5.0-internal4.zip',
      :sha256 => '40907ce65ffcec8e10cf0926f7a0d22ece9ff63653785bc29f950860cae66d03'
    }
    ...
    spec.subspec 'NimbusGAMKit' do |ss|
      ...
      ss.dependency 'Google-Mobile-Ads-SDK', '~> 9'
    end
    ...
    spec.subspec 'NimbusVungleKit' do |ss|
      ...
      ss.dependency 'NimbusSDK/NimbusKit'
      ss.dependency 'VungleSDK-iOS', '>=6.12.3'
    end
  end
