Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.27.0-internal2/Nimbus-2.27.0-internal2.zip',
      :sha256 => '994714b1c083f6f0bf57eb1c3c5edbaf5526721d298b7c7a465e4275511c3473'
    }
    ...
    spec.subspec 'NimbusGAMKit' do |ss|
      ...
      ss.dependency 'Google-Mobile-Ads-SDK', '>=9.0.0', '< 12.0.0'
    end

    spec.subspec 'NimbusAdMobKit' do |ss|
      ss.source_files = 'NimbusAdMob/NimbusAdMobKit/**/*'
      ss.dependency 'NimbusSDK/NimbusKit'
      ss.dependency 'Google-Mobile-Ads-SDK', '~> 11.7'
    end
