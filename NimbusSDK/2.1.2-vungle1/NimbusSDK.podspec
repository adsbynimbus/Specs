Pod::Spec.new do |spec|
    ...
    spec.documentation_url = 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/docs/2.1.2-vungle1/docs/index.html'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.1.2-vungle1/Nimbus-2.1.2-vungle1.zip',
      :sha256 => '863e9505ee1f3e7bd4286eeb93b5249239919dcb690ec33db9fa18d2bbd49196'
    }
    ...
    spec.subspec 'NimbusVungleKit' do |ss|
      ...
      ss.dependency 'NimbusSDK/NimbusKit'
      ss.dependency 'VungleSDK-iOS', '>=6.12.1'
    end
  end
