Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.15.4-internal9/Nimbus-2.15.4-internal9.zip',
      :sha256 => '221127812b87955e0153567c9832f20ae228094b46344f9de6038567866a0870'
    }
    ...
    spec.subspec 'NimbusRenderKit' do |ss|
      ss.vendored_frameworks = ['NimbusRenderKit.xcframework', 'NimbusMobileFuseKit.xcframework', 'OMSDK_Adsbynimbus.xcframework']
      ss.dependency 'NimbusSDK/NimbusCoreKit'
