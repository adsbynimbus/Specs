Pod::Spec.new do |spec|
    ...
    spec.xcconfig = { 'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) NimbusSDKInclude=1' }

    # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #

    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.16.0-internal7/Nimbus-2.16.0-internal7.zip',
      :sha256 => 'b73a8ad2c9ae0afef8ab50408a57655d9c5fba016bce3a2ded9c773a9e40efd6'
    }
