Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.15.4-internal8/Nimbus-2.15.4-internal8.zip',
      :sha256 => 'cf1c78d3929fa135f576da0e47071f09b4fdd10bcadd3d9ecc87dfdee1f7d051'
    }
    ...
    spec.subspec 'NimbusRequestAPSKit' do |ss|
      ...
      ss.dependency 'AmazonPublisherServicesSDK', '>=4.5.6'
    end
    ...
    spec.subspec 'NimbusRenderKit' do |ss|
      ss.vendored_frameworks = ['NimbusRenderKit.xcframework', 'OMSDK_Adsbynimbus.xcframework', 'NimbusMobileFuseKit.xcframework']
      ss.dependency 'NimbusSDK/NimbusCoreKit'
	  ss.dependency 'MobileFuseSDK', '~> 1.6.3'
    end
