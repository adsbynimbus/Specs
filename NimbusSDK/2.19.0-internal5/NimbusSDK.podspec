Pod::Spec.new do |spec|
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/sdks/2.19.0-internal5/Nimbus-2.19.0-internal5.zip',
      :sha256 => '01b5c6867022854f6ed8e53eb6ff59cdbc6e75d8838398752fa9a83d1b967ff3'
    }
    ...
    spec.subspec 'NimbusRequestAPSKit' do |ss|
      ...
      ss.dependency 'AmazonPublisherServicesSDK', '>=4.7.7'
    end
