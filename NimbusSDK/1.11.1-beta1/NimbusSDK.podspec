Pod::Spec.new do |spec|
    ...
    # spec.documentation_url = 'https://adsbynimbus-public.s3.amazonaws.com/iOS/docs/1.11.0/docs/index.html'
    ...
    spec.source = {
      :http => 'https://adsbynimbus-public.s3.amazonaws.com/dev/iOS/Nimbus-1.11.1-beta1.zip',
      :sha256 => 'b5f85e5a5f0703d907fa2e1be1dd0172e7316afac47a3c31d10b26a9776f6984'
    }
    ...
    spec.subspec 'NimbusRequestUnityKit' do |ss|
      ss.vendored_frameworks = 'NimbusRequestUnityKit.xcframework'
      ss.dependency 'NimbusSDK/NimbusCoreKit'
      ss.dependency 'NimbusSDK/NimbusRequestKit'
      ss.dependency 'UnityAds', '>=4.0.0'
    end

    spec.subspec 'NimbusRenderUnityKit' do |ss|
      ss.vendored_frameworks = 'NimbusRenderUnityKit.xcframework'
      ss.dependency 'NimbusSDK/NimbusCoreKit'
      ss.dependency 'NimbusSDK/NimbusRenderKit'
      ss.dependency 'UnityAds', '>=4.0.0'
    end
